...
public class BlankFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         */
        MyAdapter adapter2 = new MyAdapter(new String[]{"01", "02", "03", "04", "05" , "06" , "07"}, new String[]{"Test1","Test2","Test3","Test4","Test5","Test6","Test7"},new String[]{"01", "02", "03", "04", "05" , "06" , "07"}, rootView.getContext());
